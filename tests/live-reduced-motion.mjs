...
await page.goto("https://radarme.vercel.app/radarmusic", { waitUntil: "networkidle", timeout: 60000 });
await page.waitForTimeout(500);
const result = await page.evaluate(() => ({
  reducedMotion: matchMedia("(prefers-reduced-motion: reduce)").matches,
  botVisible: Boolean(document.querySelector(".radar-bot-wrapper")),
  activeAnimations: [...document.querySelectorAll(".radar-bot-wrapper *")].map((el) => getComputedStyle(el).animationName).filter((name) => name !== "none"),
