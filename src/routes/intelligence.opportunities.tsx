          ...
          <article key={o.title} className="rounded-2xl bg-surface p-4 hairline glass-reflect">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 line-clamp-2 font-display text-[15px] font-semibold leading-tight">{o.title}</p>
                <p className="mt-1 flex items-center gap-2 text-[11px] text-muted-foreground">
                  <span className="inline-flex items-center gap-1"><MapPin size={11} /> {o.loc}</span>
                  <span>· by {o.deadline}</span>
                </p>
              </div>
              <button type="button" className="shrink-0 rounded-full bg-gold px-3 py-1.5 text-[12px] font-semibold text-gold-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring">
                Apply
              </button>
            </div>
          </article>
